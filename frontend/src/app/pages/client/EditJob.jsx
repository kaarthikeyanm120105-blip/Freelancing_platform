...
import { Briefcase, IndianRupee, Calendar, Layers, Star, Info, ChevronLeft } from 'lucide-react';
...
export default function EditJob() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const skillsArray = typeof formData.skillsRequired === 'string'
                ? formData.skillsRequired.split(',').map((skill) => skill.trim()).filter((s) => s !== '')
    ...
    if (fetching) return <div className="flex justify-center py-20">Loading job data...</div>;
        ...
        <div className="max-w-4xl mx-auto py-8">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-500">Update your project requirements and status</p>
                </div>
            </div>
            ...
            <Card className="p-8 border-2 shadow-sm">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-gray-700 flex items-center gap-2">
                                <Info className="w-4 h-4 text-indigo-500" /> Job Status
                            </label>
                            <select
                                name="status"
                                className="w-full p-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 border-gray-200"
